    ...
    <div class="welcome-block">
      ...
      <div class="about">
        <div class="about-text">
          ...
          <div class="about-p">
            <p>廣大的海拉魯擁有美麗的自然環境與不為人知的秘境，</p>
            <p>這裡也住著許多個性十足的人與怪物……</p>
            <p>除此之外，它也具備許多的樣貌。</p>
            <p>以下我們將為您介紹幾個海拉魯不可不去的景點。</p>
            <p>即使您已經走遍整個海拉魯，或許也會有新的發現。</p>
          </div>
        </div>
...
<style>
  *{
  ...
  @keyframes aboutAnimate{
    ...
    100%{
      background-position: 22.15% 35.6%;     
    }
  }
  .region-group{
    width: 100%;
